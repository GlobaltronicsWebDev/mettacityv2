...
<form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="url" name="facebook_link" class="form-control @error('facebook_link') is-invalid @enderror" value="{{ old('facebook_link', $news->facebook_link) }}" placeholder="https://facebook.com/...">
    ...
    <div class="mb-3">
        ...
        <input type="url" name="custom_link" class="form-control @error('custom_link') is-invalid @enderror" value="{{ old('custom_link', $news->custom_link) }}" placeholder="https://...">
