...
<header class="header-bg" id="siteHeader">
  ...
  =========================== -->
  <img src="<?php echo e(asset('./assets/NAVIGATIONBAR.png')); ?>"
    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <div class="col-12 d-flex align-items-center justify-content-between d-md-none">
          ...
          <!-- MOBILE LOGO (LEFT) -->
          <a href="<?php echo e(route('home')); ?>" class="mobile-logo-link">
            <img src="<?php echo e(asset('./assets/METTACITY Logo.png')); ?>"
        ...
        <div class="col-4 d-none d-md-flex align-items-center">
          <ul class="header-nav">
            ...
            <li>
              <a class="nav-link active" href="<?php echo e(route('ticketing')); ?>">Tickets</a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo e(route('news')); ?>">Latest News</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('careers')); ?>">Careers</a></li>
              </ul>
            </li>
        ...
        <div class="col-4 d-none d-md-flex align-items-center justify-content-end gap-3 pe-4">
          ...
          <!-- CTA LINK -->
          <a class="nav-link active" href="<?php echo e(route('visit')); ?>">
            <img src="<?php echo e(asset('./assets/PLAN YOUR VISIT.png')); ?>"
...
<div class="offcanvas offcanvas-end mobile-offcanvas"
  ...
  <div class="offcanvas-body mobile-offcanvas-body">
    ...
    <div class="mobile-offcanvas-top">
      ...
      <a href="<?php echo e(route('visit')); ?>" class="mobile-plan-visit">
        <img src="<?php echo e(asset('./assets/PLAN YOUR VISIT.png')); ?>"
             alt="Plan Your Visit">
      </a>
    ...
    <nav class="mobile-nav">
      ...
      <a class="mobile-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>"
         href="<?php echo e(route('home')); ?>">
        Home
      </a>

      <a class="mobile-link <?php echo e(request()->routeIs('aboutus') ? 'active' : ''); ?>"
         href="<?php echo e(route('aboutus')); ?>">
        About Us
      </a>

      <a class="mobile-link <?php echo e(request()->routeIs('ticketing') ? 'active' : ''); ?>"
         href="<?php echo e(route('ticketing')); ?>">
        Tickets
      </a>
      ...
      <a class="mobile-link <?php echo e(request()->routeIs('news') ? 'active' : ''); ?>"
         href="<?php echo e(route('news')); ?>">
        Latest News
      </a>

      <a class="mobile-link <?php echo e(request()->routeIs('careers') ? 'active' : ''); ?>"
         href="<?php echo e(route('careers')); ?>">
        Careers
      </a>
...
<?php /**PATH C:\Users\marke\OneDrive\Desktop\METTACITY MAIN\mettacityv2\resources\views/navbar.blade.php ENDPATH**/ ?>